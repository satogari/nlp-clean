...
export interface CreateCampaignCatalogUseCaseInputPort {
    execute(request: CreateCampaignCatalogUseCaseRequest): Promise<CatalogCampaign>
}

export const CreateCampaignCatalogUseCaseInputPort = Symbol("CreateCampaignCatalogUseCaseInputPort")